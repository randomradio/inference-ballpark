(function () {
  ...
  const READ = {
    ...
    phase: "切到 Decode 时，激活盒子变矮（T→1），cache 盒子仍按序列长 S 画。左边竖条标种类：激活 / 权重 / 算子 / cache / 通信。",
    cost: "图不画时间。选中后看本页「代价」和下面的 FLOPs / 读写 / 通信。最慢的盒子左边竖条更重。",
  };
    ...
    "glm-52": {
      ...
      pages: {
        ...
        dsa: {
          ...
          map: "Indexer Q 叠 32 头；scores 的高随 T×S。IndexShare 是cache，不是新算子。",
        ...
        ep: {
          ...
          map: "虚线边是通信。专家格在本地卡上，只亮本卡分到的 expert。",
      ...
      nodes: {
        ...
        index_share: {
          ...
          map: "cache，形状与 Top-K indices 相同。",
